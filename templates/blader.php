...
<section>
	...
	<h3>These are the classes currently in Cabal Online</h3>
		<fieldset >
			<table >
				<legend>Blader</legend>
				<tr><td><ul><li>Medium type</li></ul></td></tr>
				<tr><td><ul><li>Deals huge amounts of damage</li></ul></td></tr>
				<tr><td><ul><li>Has a considerably low def rate, but a very high attack rate</li></ul></td></tr>
			</table>
		</fieldset>
...
<section>
<h3 align="center" style="text-decoration: underline;">A short video about a blader class</h3>

	<video id="myVideo" width="640" height="420" controls>
	  <source src="../CabalClasses/BL.mp4" type="video/mp4">
	  <source src="../CabalClasses/BL.ogg" type="video/ogg">
