...
<section>
<h3 align="center" style="text-decoration: underline;">A short video about a gladiator class</h3>

	<video id="myVideo" width="640" height="420" controls>
	  <source src="../CabalClasses/GL.mp4" type="video/mp4">
	  <source src="../CabalClasses/GL.ogg" type="video/ogg">
