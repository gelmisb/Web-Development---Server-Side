...
<section>
	...
	<h3>These are the classes currently in Cabal Online</h3>
		<fieldset >
			<table >
				<legend>Force Blader</legend>
				<tr><td><ul><li>A light type character</li></ul></td></tr>
				<tr><td><ul><li>Deals </li></ul></td></tr>
...
<h3 align="center" style="text-decoration: underline;">A short video about a warrior</h3>
	...
	<video id="myVideo" width="640" height="420" controls>
	  <source src="../CabalClasses/FB.mp4" type="video/mp4">
	  <source src="../CabalClasses/FB.mp4.ogg" type="video/ogg">
