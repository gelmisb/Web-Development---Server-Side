...
<section>
	...
	<h3>These are the classes currently in Cabal Online</h3>
		<fieldset >
			<table >
				<legend>Force archer</legend>
				<tr><td><ul><li>A light type, (same as WI)</li></ul></td></tr>
				<tr><td><ul><li>Deals medium amounts of damage</li></ul></td></tr>
				<tr><td><ul><li>High attack rate, low def def rate</li></ul></td></tr>
			</table>
		</fieldset>
...
<section>
<h3 align="center" style="text-decoration: underline;">A short video about a force archer cl</h3>

	<video id="myVideo" width="640" height="420" controls>
	  <source src="../CabalClasses/Fa.mp4" type="video/mp4">
	  <source src="../CabalClasses/Fa.ogg" type="video/ogg">
